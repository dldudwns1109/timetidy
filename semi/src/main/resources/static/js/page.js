    ...
    $("<button>")
      ...
      .append(
        $("<div>")
          ...
          .append(
            $("<img>").attr("src", "/img/doc.svg").addClass("w-24 h-24 mr-8")
          )
          .append(
            $("<span>")
      ...
      .append(
        $("<button>")
          ...
          .append(
            $("<img>").attr("src", "/img/trash.svg").addClass("w-100p h-100p")
          )
          .click(function (e) {
            e.stopPropagation();
            $.ajax({
              ...
              method: "POST",
              data: {
                pageId: $(this).closest(".date-tab").data("id"),
              },
      ...
      .click(function () {
        location.replace(
          "/schedule/" + $(this).closest(".date-tab").data("id")
        );
      })
  );
}
