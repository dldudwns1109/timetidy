export function jobAddInput(pageId) {
  var header = $("meta[name='_csrf_header']").attr("content");
  var token = $("meta[name='_csrf']").attr("content");
  $(".job-content").append(
    $("<div>")
      .addClass("job-input flex flex-col p-16 mb-32 line-base border-1 round-6")
      .append(
        $("<input>")
          .attr("placeholder", "제목")
          .addClass(
      ...
      .append($("<div>").addClass("job-datetime"))
          ...
          .append(
            $("<div>")
              ...
              .append(
                $("<button>")
                  .addClass(
                    "flex items-center border-1 negative-b round-6 trans-color outline-none py-6 pl-6 pr-8 mr-8"
                  )
                  .append(
                    $("<img>").attr("src", "/img/close.svg").addClass("mr-4")
                  )
                  .append(
                    $("<span>")
                      .text("취소")
              ...
              .append(
                $("<button>")
                  .addClass(
                    "flex items-center border-1 brand-b round-6 trans-color outline-none py-6 pl-6 pr-8"
                  )
                  .append(
                    $("<img>").attr("src", "/img/plus.svg").addClass("mr-4")
                  )
                  .append(
                    $("<span>")
                      .text("추가")
                        ...
                        success: function (res) {
                          ...
                          $(".job-content").append(
                            $("<div>")
                              ...
                              .addClass(
                                "job-tab flex flex-col p-16 mb-32 line-base border-1 round-6"
                              )
                              .append(
                                $("<span>")
                                  .text(res.jobTitle)
                          ...
                          if (res.jobPlace != null) {
                            ...
                            var address = $(
                              '[data-id="' + res.jobId + '"] .job-place-address'
                            ).text();
