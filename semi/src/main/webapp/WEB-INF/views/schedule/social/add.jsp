...
<html lang="ko">
  <head>
    ...
    <script type="module">
      ...
      import { memberSocialList } from "/js/member-social-list.js";
      $(function () {
      ...
      >
        <div class="page-content w-620 py-64">
          ...
          <div class="inline-block light-dark mt-24 px-4 py-4 round-full">
            <button
              class="social-list-tab-btn trans-color border-none outline-none px-12 py-10 round-full text-14 title-font-color"
            >
              목록
            </button>
            <button
              class="social-add-tab-btn light border-none outline-none px-12 py-10 round-full text-14 title-font-color"
            >
              추가
            </button>
          </div>
